...
<body>
<div id="header1">
	<p id="title">TvShowWatch</p>
</div>
<div id="header2">
	<ul class="rubs">
		<li<?php if( $page == 'home' ){ ?> class="actif"<?php } ?>><a href="index.php?page=home">Home</a></li>
		<li<?php if( $page == 'config' ){ ?> class="actif"<?php } ?>><a href="index.php?page=conf">General Conf</a></li>

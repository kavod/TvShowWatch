...
<div id="header2">
	<ul class="rubs">
		...
		<li><a href="index.php?page=general_conf">General Conf</a></li>
		<li><a href="index.php?page=keywords">Keywords</a></li>
		<li class="actif"><a href="index.php?page=series_list">Series List</a></li>
	</ul>
</div>
